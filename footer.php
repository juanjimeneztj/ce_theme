        ...
        <?=(file_exists($_SERVER['DOCUMENT_ROOT'].'/wp-content/themes/chartexperts/vendor/twbs/bootstrap/dist/js/bootstrap.min.js'))?'<script src="'.get_template_directory_uri().'/vendor/twbs/bootstrap/dist/js/bootstrap.min.js"></script>':'<script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous"></script><script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>';?>

        <?=(file_exists($_SERVER['DOCUMENT_ROOT'].'/wp-content/themes/chartexperts/vendor/fortawesome/font-awesome/js/all.min.js'))?'<script src="'.get_template_directory_uri().'/vendor/fortawesome/font-awesome/js/all.min.js"></script>':'<script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/js/all.min.js"></script>';?>
